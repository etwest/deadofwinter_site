...
def init():
    ...
    while True:
        ...
        if len(games) == 0 or game_code not in games.keys():
            break
    games[game_code] = Game(player_obj_map, start_cards, police_cards, grocery_cards, school_cards, library_cards, hospital_cards, gas_station_cards)
